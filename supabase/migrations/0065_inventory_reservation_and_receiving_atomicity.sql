create unique index if not exists inventory_reservations_identity_with_request_unique_idx
...
create unique index if not exists inventory_reservations_identity_without_request_unique_idx
on public.inventory_reservations (
  company_id,
  inventory_item_id,
  stock_location_id,
...
where part_request_line_id is null;
