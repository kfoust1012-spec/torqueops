...
import { searchEstimatePartOffers } from "../../../../../../../lib/estimates/workspace/service";
...
export async function POST(request: Request, { params }: RouteProps) {
  ...
  try {
    ...
    const workspace = await searchEstimatePartOffers(
      context.supabase,
      context.companyId,
    ...
    return createEstimateWorkspaceApiErrorResponse(
      error,
      "Supplier search could not be completed."
    );
  }
}
