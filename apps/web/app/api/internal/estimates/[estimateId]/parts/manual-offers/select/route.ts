...
import { selectEstimateManualPartOffer } from "../../../../../../../../lib/estimates/workspace/service";
...
export async function POST(request: Request, { params }: RouteProps) {
  ...
  try {
    ...
    const workspace = await selectEstimateManualPartOffer(
      context.supabase,
      context.companyId,
      estimateId,
      body as never
    ...
    return createEstimateWorkspaceApiErrorResponse(
      error,
      "Manual supplier offer could not be selected."
    );
  }
}
